...
import InternationalFlightSearchForm from "./components/InternationalFlightSearchForm";
    ...
    <div>
      <SearchFormTabs
        tabs={[
          ...
          {
            content: <InternationalFlightSearchForm />,
            label: "پرواز خارجی",
            icon: (
              <svg
                viewBox="0 0 24 24"
