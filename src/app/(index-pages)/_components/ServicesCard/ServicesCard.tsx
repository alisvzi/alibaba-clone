  ...
  return (
    <>
      <div className="flex items-center justify-between flex-wrap mb-4">
        <div className="max-w-[590px] h-[244.5px] rounded-lg border border-border overflow-hidden">
          <Image
            src="https://cdn.alibaba.ir/cms/uploads/AL_Digitalmarketing_on_going_Safar_Card_Cardview_Banner_Desktop_03_10_29_84e3e680f4.webp"
            alt="servis1"
            width={590}
            height={245}
            className=""
        ...
        <div className="max-w-[590px] h-[244.5px] rounded-lg border border-border overflow-hidden">
          <Image
            src="https://cdn.alibaba.ir/cms/uploads/AL_Digitalmarketing_ongoing_Installmentpurchase_Cardview_Banner_Desktop_04_0_3_13_20a96cb7f0.webp"
            alt="servis1"
            width={590}
            height={245}
            className=""
